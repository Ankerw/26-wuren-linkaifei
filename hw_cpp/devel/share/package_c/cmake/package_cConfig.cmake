...
if(package_c_CONFIG_INCLUDED)
  return()
endif()
set(package_c_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(package_c_SOURCE_PREFIX /home/anker/hw_all/hw_cpp/src/package_c)
  set(package_c_DEVEL_PREFIX /home/anker/hw_all/hw_cpp/devel)
  set(package_c_INSTALL_PREFIX "")
  set(package_c_PREFIX ${package_c_DEVEL_PREFIX})
else()
  set(package_c_SOURCE_PREFIX "")
  set(package_c_DEVEL_PREFIX "")
  set(package_c_INSTALL_PREFIX /home/anker/hw_all/hw_cpp/install)
  set(package_c_PREFIX ${package_c_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'package_c' is deprecated")
...
set(package_c_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'anker <anker@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${package_c_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'package_c' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'package_c' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anker/hw_all/hw_cpp/src/package_c/${idir}'.  ${_report}")
    endif()
    _list_append_unique(package_c_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND package_c_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND package_c_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT package_c_NUM_DUMMY_TARGETS)
      set(package_c_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::package_c::wrapped-linker-option${package_c_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR package_c_NUM_DUMMY_TARGETS "${package_c_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::package_c::wrapped-linker-option${package_c_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND package_c_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND package_c_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/anker/hw_all/hw_cpp/devel/lib;/home/anker/catkin_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(package_c_LIBRARY_DIRS ${lib_path})
      list(APPEND package_c_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'package_c'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND package_c_LIBRARIES ${lib})
    endif()
  endif()
...
set(package_c_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${package_c_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;rospy;std_msgs;rosbag;geometry_msgs;fsd_common_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 package_c_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${package_c_dep}_FOUND)
      find_package(${package_c_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${package_c_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(package_c_INCLUDE_DIRS ${${package_c_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(package_c_LIBRARIES ${package_c_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${package_c_dep}_LIBRARIES})
  _list_append_deduplicate(package_c_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(package_c_LIBRARIES ${package_c_LIBRARIES})

  _list_append_unique(package_c_LIBRARY_DIRS ${${package_c_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(package_c_EXPORTED_TARGETS ${${package_c_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${package_c_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
